<html>
	...
	<body>
		...
		?>
			...
			<?php
			$file=fopen("1.txt", 'r');
			echo "no. of votes=".fread($file, filesize("1.txt"));
			fclose($file);
			?>
            </div>
			...
			<?php
			$file=fopen("2.txt", 'r');
			echo "no. of votes=".fread($file, filesize("2.txt"));
			fclose($file);
			?>
			</div>
			...
			<?php
			$file=fopen("3.txt", 'r');
			echo "no. of votes=".fread($file, filesize("3.txt"));
			fclose($file);
			?>
			</div>
			...
			<?php
			$file=fopen("4.txt", 'r');
			echo "no. of votes=".fread($file, filesize("4.txt"));
			fclose($file);
			?>
			</div>
			...
			<?php
			$file=fopen("5.txt", 'r');
			echo "no. of votes=".fread($file, filesize("5.txt"));
			fclose($file);
			?>
			</div>
			...
			<?php
			$file=fopen("6.txt", 'r');
			echo "no. of votes=".fread($file, filesize("6.txt"));
			fclose($file);
			?>
			</div>
		</form>
        ...
        echo "<center><br><br><br><br><br><h2>You need to wait till 15-Aug-2021 <br><br> To see the votes of the contestant</h2><center>";
